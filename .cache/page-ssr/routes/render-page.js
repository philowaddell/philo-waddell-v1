...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7513);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1323);
/* harmony import */ var _emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5658);
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !_emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__.h.call(props, 'css')) {
    // $FlowFixMe
  ...
  createElementArgArray[0] = _emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__.E;
  createElementArgArray[1] = (0,_emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__.c)(type, props);
...
var Global = /* #__PURE__ */(0,_emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__.w)(function (props, cache) {
  if (false) {}

  var styles = props.styles;
  var serialized = (0,_emotion_serialize__WEBPACK_IMPORTED_MODULE_5__/* .serializeStyles */ .O)([styles], undefined, (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__.T));

  if (!_emotion_element_fc314d24_esm_js__WEBPACK_IMPORTED_MODULE_6__.i) {
    var _ref;
...
var _react = _interopRequireDefault(__webpack_require__(7513));
...
var getGlobalPathPrefix = function getGlobalPathPrefix() {
  return  false ? 0 : "/philo-waddell-v1";
};
...
var React = _interopRequireWildcard(__webpack_require__(7513));
...
var _react = __webpack_require__(7513);
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 9616)),"component---src-pages-desktop-js":()=>__webpack_require__.e(/* import() | component---src-pages-desktop-js */ 152).then(__webpack_require__.bind(__webpack_require__, 9735)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 7704)),"component---src-pages-mobile-js":()=>__webpack_require__.e(/* import() | component---src-pages-mobile-js */ 366).then(__webpack_require__.bind(__webpack_require__, 3310))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(573),options:{"plugins":[]}},{name:'gatsby-plugin-mdx',plugin:__webpack_require__(929),options:{"plugins":[],"extensions":[".mdx"],"defaultLayouts":{},"gatsbyRemarkPlugins":[],"lessBabel":false,"remarkPlugins":[],"rehypePlugins":[],"mediaTypes":["text/markdown","text/x-markdown"],"root":"/home/philo/development/philo-waddell-v1","commonmark":false}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/philo-waddell-v1"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/philo-waddell-v1"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/philo-waddell-v1"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromise,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload=_objectSpread(_objectSpread({},pageResources),{},{staticQueryResults});finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
"use strict";
module.exports = require("/home/philo/development/philo-waddell-v1/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/home/philo/development/philo-waddell-v1/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/home/philo/development/philo-waddell-v1/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-69ca7560e9c6196f54a3.js"],"app":["/app-685c88c1812fbe1079e1.js"],"component---src-pages-404-js":["/component---src-pages-404-js-b7e3da51cfdd9d3c2cf1.js"],"component---src-pages-desktop-js":[],"component---src-pages-index-js":["/component---src-pages-index-js-7369943e7a65aae2c9ef.js"],"component---src-pages-mobile-js":["/component---src-pages-mobile-js-d3bd52c29059f1d18086.js"]}');
...
/******/ 			return "" + {"152":"component---src-pages-desktop-js","366":"component---src-pages-mobile-js","678":"component---src-pages-index-js","883":"component---src-pages-404-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/philo-waddell-v1/";
/******/ 	})();
/******/ 	
